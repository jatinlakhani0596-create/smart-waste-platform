import type { ComplaintCategory, ReportSeverity } from "../data/models.js";
...
const departmentMap: Record<ComplaintCategory, string> = {
...
export function analyzeComplaintText(text: string): GrievanceAnalysis {
